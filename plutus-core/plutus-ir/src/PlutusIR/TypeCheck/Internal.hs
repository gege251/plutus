...
withNoEscapingTypes :: Monad m => PirTCEnv uni fun m a -> PirTCEnv uni fun m a
...
withTyVarDecls
    :: Monad m => [TyVarDecl TyName ann] -> TypeCheckT uni fun cfg m a -> TypeCheckT uni fun cfg m a
